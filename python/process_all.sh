...
python process_raw_data.py ./data/192/raw ./data/64/

python process_raw_data.py ./data/192/raw ./data/64/ -t mr

python process_raw_data.py ./data/192/raw ./data/64/ -t ct
